    ...
    <header class="header">
         <div class="main-header">
             <div class="ecommerce-menu">
                <div class="logo">
                    <h2><a href="<?=base_url?>"><i class="fas fa-cat"></i></i></a></h2>
                </div>
             ...
             <div class="user-menu">
                    ...
                    <div class="profile-hover-menu hidden">
                        <ul>
                            <?php if(isset($_SESSION['admin'])): ?>
                                <li><a href="<?=base_url?>category/index">Gérer les catégories</a> </li>
                                <li><a href="<?=base_url?>product/manage">Gérer les produits</a> </li>
                                <li><a href="<?=base_url?>order/manage">Gérer les commandes</a></li>
                                <?php endif; ?>
                                <li><a href="<?=base_url?>order/myOrders">Mes commandes</a></li>
                 ...
                 <div class="login">
                    <?php if(isset($_SESSION['identity'])): ?>
                        <p>Bienvenue, <?=$_SESSION['identity']->first_name?>!</p>
                    <?php else: ?>
                    <p>Login</p>
                    <?php endif; ?>
                </div>
